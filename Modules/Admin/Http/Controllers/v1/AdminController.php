...
class AdminController extends BaseApiController
{
    ...
    public function store(AdminCreateRequest $request)
    {
        return (new AdminService())->store($request->only([
            ...
            'password',
            'group_id',
            'project_id','post_name','department_id'
        ]));
    }
    /**
     * @name 修改页面
    ...
    {
        return (new AdminService())->update($request->get('id'),$request->only(['username','group_id','phone','name','project_id','post_name','department_id']));
    }
    /**
     * @name 调整状态
     * @description
    ...
    public function import(Request $request){
        return $this->apiResponse(function()use($request){
            return (new AdminService())->import($request);
        });
    }
     ...
     * @return mixed
     */
    public function delUniqueId(Request $request){
        return $this->apiResponse(function()use($request){
            return (new AdminService())->delUniqueId($request->input('id'));
        });
    }
}
