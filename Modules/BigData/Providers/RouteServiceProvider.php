...
namespace Modules\BigData\Providers;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\BigData\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(module_path('BigData', '/Routes/web.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->moduleNamespace)
            ->group(module_path('BigData', '/Routes/api.php'));
    }
}
